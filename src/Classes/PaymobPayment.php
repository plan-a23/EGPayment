...
class PaymobPayment implements PaymentInterface
{
    ...
    {
        $this->paymob_api_key = config('PlanA23-payments.PAYMOB_API_KEY');
        $this->paymob_integration_id = config('PlanA23-payments.PAYMOB_INTEGRATION_ID');
        $this->paymob_iframe_id = config("PlanA23-payments.PAYMOB_IFRAME_ID");
        $this->currency = config("PlanA23-payments.PAYMOB_CURRENCY");
    }
