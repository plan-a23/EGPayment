...
class TapPayment implements PaymentInterface
{
    ...
    {
        $this->currency = config('PlanA23-payments.TAP_CURRENCY');
        $this->tap_secret_key = config('PlanA23-payments.TAP_SECRET_KEY');
        $this->tap_public_key = config('PlanA23-payments.TAP_PUBLIC_KEY');
        $this->tap_lang_code = config('PlanA23-payments.TAP_LANG_CODE');
