...
class ThawaniPayment implements PaymentInterface
{
    ...
    {
        $this->thawani_url = config('PlanA23-payments.THAWANI_URL');
        $this->thawani_api_key = config('PlanA23-payments.THAWANI_API_KEY');
        $this->thawani_publishable_key = config('PlanA23-payments.THAWANI_PUBLISHABLE_KEY');
