...
use PlanA23\EGPayment\Classes\BaseController;
...
class PayPalPayment implements PaymentInterface
{
    ...
    {
        $this->paypal_client_id = config('PlanA23-payments.PAYPAL_CLIENT_ID');
        $this->paypal_secret = config('PlanA23-payments.PAYPAL_SECRET');
        $this->verify_route_name = config('PlanA23-payments.VERIFY_ROUTE_NAME');
        $this->paypal_mode = config('PlanA23-payments.PAYPAL_MODE');
        $this->currency = config('PlanA23-payments.PAYPAL_CURRENCY');
    }
