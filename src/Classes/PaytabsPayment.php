...
class PaytabsPayment implements PaymentInterface
{
    ...
    {
        $this->paytabs_profile_id = config('PlanA23-payments.PAYTABS_PROFILE_ID');
        $this->paytabs_base_url = config('PlanA23-payments.PAYTABS_BASE_URL');
        $this->paytabs_server_key = config('PlanA23-payments.PAYTABS_SERVER_KEY');
        $this->paytabs_checkout_lang = config('PlanA23-payments.PAYTABS_CHECKOUT_LANG');
        $this->currency = config('PlanA23-payments.PAYTABS_CURRENCY');
