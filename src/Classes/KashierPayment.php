...
class KashierPayment implements PaymentInterface
{
    ...
    {
        $this->kashier_url = config("PlanA23-payments.KASHIER_URL");
        $this->kashier_webhook_url = config("PlanA23-payments.KASHIER_WEBHOOK_URL");
        $this->kashier_mode = config("PlanA23-payments.KASHIER_MODE");
        $this->kashier_account_key = config("PlanA23-payments.KASHIER_ACCOUNT_KEY");
        $this->kashier_iframe_key = config("PlanA23-payments.KASHIER_IFRAME_KEY");
        $this->kashier_token = config("PlanA23-payments.KASHIER_TOKEN");
        $this->currency = config('PlanA23-payments.KASHIER_CURRENCY');
    ...
    {
        return view('PlanA23::html.kashier', ['model' => $this, 'data' => $data])->render();
    }
